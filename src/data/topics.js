export const topics = [
  ...
  { id: 'recurrence:introduction', moduleId: 'recurrence', title: '动态系统与离散时间', summary: '用一步一步更新的状态描述系统变化。', status: 'open' },
  { id: 'recurrence:first-order', moduleId: 'recurrence', title: '一阶递推关系', summary: '由 x_k 计算 x_{k+1}，包括 logistic map。', status: 'open' },
  { id: 'recurrence:second-order', moduleId: 'recurrence', title: '二阶递推关系', summary: '使用前两个值计算下一项并应用初始条件。', status: 'open' },
  { id: 'recurrence:matrix', moduleId: 'recurrence', title: '状态向量与矩阵形式', summary: '把二阶递推改写为 y_{k+1}=Ay_k。', status: 'open' },
  { id: 'recurrence:stability', moduleId: 'recurrence', title: '特征值与长期行为', summary: '从特征值直觉判断衰减、震荡与增长。', status: 'open' },
